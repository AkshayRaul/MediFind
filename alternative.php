...
Enter the medicine you want to find the alternative for:<input type="text" name="alt">
<div class="container">
...
include("connect.php");
	$sql = "Select name, Medicine_Name, Drug_1,Drug_2,Drug_3,Manufacturer, Drug_Quantity,Quantity ,Price from markers, Medicine_Info ,Chemist_Has where Quantity="Select Quantity from Medicine_Info where Medicine_Name='".$text1."'"and Medicine_Info.Medicine_Name=Chemist_Has.medicine and Chemist_Has.id=markers.id  ";
	$result = $db->query($sql);
